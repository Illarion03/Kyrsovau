...
В ходе выполнения курсового проекта средствами MsSQL была разработана информационная система «Продажа домов и квартир», предназначенная для автоматизации работы директора магазина.
